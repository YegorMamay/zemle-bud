...
(function(w, d, $, ajax) {
    $(function() {
        ...
        buyOneClick(".one-click-ru", '[data-field-id="field11"]', "h1.single-title");
        $d.on("copy", addLink);
    ...
    var reviews = function reviews(container) {
        ...
        if (element.children().length > 1 && typeof $.fn.slick === "function") {
            element.slick({
                ...
                autoplaySpeed: 3e3,
                arrows: true,
                prevArrow: '<button type="button" class="slick-prev"><svg class="slick-icon"><use xlink:href="#left-arrow"></use></svg></button>',
                nextArrow: '<button type="button" class="slick-next"><svg class="slick-icon"><use xlink:href="#right-arrow"></use></svg></button>',
                dots: true,
